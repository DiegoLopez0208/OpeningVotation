...
const Countdown: React.FC = () => {
  const fechaFutura: Date = new Date(
    "Mon Nov 18 2024 00:00:00 GMT-0300 (hora estándar de Argentina)"
  );
  ...
  return (
    <div className="text-blue-800 dark:text-blue-300 text-center font-bold text-4xl ">
      {timeLeft.days >= 0 ? (
        ...
        <span className="text-3xl mb-4">¡La votación finalizó!</span>
      )}
    </div>
  );
};
